...
INSERT INTO `personal_finance`.`pf_enum` (`id`, `enum_key`, `enum_value`, `enum_catagory`) VALUES ('8', '6', '日常家用', 'catagory');
INSERT INTO `personal_finance`.`pf_enum` (`id`, `enum_key`, `enum_value`, `enum_catagory`) VALUES ('9', '7', '通信网络费', 'catagory');
